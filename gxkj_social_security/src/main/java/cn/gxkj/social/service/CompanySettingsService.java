...
import cn.gxkj.model.social_security.CompanySettings;
import cn.gxkj.model.social_security.UserSocialSecurity;
import cn.gxkj.social.dao.CompanySettingsDao;
...
public class CompanySettingsService {
    ...
    public void newReport(String companyId, String yearMonth) {
		CompanySettings companySettings = this.findById(companyId);
